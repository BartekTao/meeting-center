                  ...
                  <div class="listing-item">
                    ...
                    <div class="right-content align-self-center">
                      ...
                      <ul class="info style1" style="padding-left: 0rem;">
                        <li style="flex: 0 0 25%">人數限制：{{ item.capacity }}</li>  
                        <li style="flex: 0 0 25%">有白板：{{ item.equipments.includes('TABLE') ? '是' : '否' }}</li>
                        <li style="flex: 0 0 25%">有投影機：{{ item.equipments.includes('PROJECTOR') ? '是' : '否' }}</li>
                        <li style="flex: 0 0 25%">可否進食：{{ item.rules.includes('NO_FOOD') ? '否' : '是' }}</li>
